...
class SongsController with ChangeNotifier {
  ...
  Future<List<Map<String, dynamic>>> getRanked() async {
    ...
    DateTime todayStartDate = DateTime(currentDate.year, currentDate.month, currentDate.day);
    DateTime todayEndDate = DateTime(currentDate.year, currentDate.month, currentDate.day, 23, 59, 59);
    ...
    List<SongModel> songsPlayedToday = songs
        .where((song) => song.playCount > 0) // You can add additional conditions if needed
        .toList();
  ...
  Future<List<Map<String, dynamic>>> getRankedUsers() async {
    ...
    rankedUsers.sort((a, b) =>
        b['totalPlayCount'].compareTo(a['totalPlayCount']));
