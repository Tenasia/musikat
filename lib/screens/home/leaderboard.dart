    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            TabBar(
                indicator: PillTabIndicator( // Custom indicator
                  indicatorColor: const Color(0xffE28D00), // Color of the pill-shaped indicator
                  ...
                  Column(
                    children: [
                      ...
                      Expanded(
                        child: FutureBuilder(
                          future:
                          _songCon.getRankedUsers(),
                          builder: (BuildContext context,
                              AsyncSnapshot<List<Map<String, dynamic>>> snapshot) {
                            if (snapshot.hasData) {
                              final List<Map<String, dynamic>> rankedArtists = snapshot.data!;
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  final UserModel user = rankedArtists[index]['user'];
...
class PillTabIndicator extends Decoration {
  ...
  PillTabIndicator({this.indicatorHeight = 30, this.indicatorColor = Colors.white});
...
class _PillTabIndicatorPainter extends BoxPainter {
  ...
  _PillTabIndicatorPainter(this.decoration, VoidCallback? onChanged) : super(onChanged);

  @override
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    final Rect rect = Offset(offset.dx, (configuration.size!.height - decoration.indicatorHeight) / 2.0) &
    Size(configuration.size!.width, decoration.indicatorHeight);
    final Paint paint = Paint()..color = decoration.indicatorColor;
    final RRect rRect = RRect.fromRectAndCorners(rect, topLeft: const Radius.circular(25), topRight: const Radius.circular(25));
